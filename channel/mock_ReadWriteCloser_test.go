...
func (_m *MockReadWriteCloser) Read() (chMsgPkt, error) {
	ret := _m.Called()

	var r0 chMsgPkt
	if rf, ok := ret.Get(0).(func() chMsgPkt); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(chMsgPkt)
	}
...
func (_m *MockReadWriteCloser) Write(_a0 chMsgPkt) error {
	ret := _m.Called(_a0)

	var r0 error
	if rf, ok := ret.Get(0).(func(chMsgPkt) error); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Error(0)
	}
